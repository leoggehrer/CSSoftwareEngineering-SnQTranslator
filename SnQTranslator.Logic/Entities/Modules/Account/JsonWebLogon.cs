...
{
    using System;
    partial class JsonWebLogon : SnQTranslator.Contracts.Modules.Account.IJsonWebLogon
    {
        static JsonWebLogon()
        {
            ClassConstructing();
        ...
        {
            if (obj is not SnQTranslator.Contracts.Modules.Account.IJsonWebLogon instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(SnQTranslator.Contracts.Modules.Account.IJsonWebLogon other)
        {
            if (other == null)
            {
                return false;
