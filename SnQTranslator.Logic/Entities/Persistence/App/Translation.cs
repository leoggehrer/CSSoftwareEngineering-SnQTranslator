...
{
    using System;
    partial class Translation : SnQTranslator.Contracts.Persistence.App.ITranslation
    {
        static Translation()
        {
            ClassConstructing();
        ...
        {
            if (obj is not SnQTranslator.Contracts.Persistence.App.ITranslation instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(SnQTranslator.Contracts.Persistence.App.ITranslation other)
        {
            if (other == null)
            {
                return false;
            }
            return IsEqualsWith(AppName, other.AppName)
            && KeyLanguage == other.KeyLanguage
