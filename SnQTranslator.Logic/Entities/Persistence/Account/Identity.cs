...
{
    using System;
    partial class Identity : SnQTranslator.Contracts.Persistence.Account.IIdentity
    {
        static Identity()
        {
            ClassConstructing();
        ...
        {
            if (obj is not SnQTranslator.Contracts.Persistence.Account.IIdentity instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(SnQTranslator.Contracts.Persistence.Account.IIdentity other)
        {
            if (other == null)
            {
                return false;
