...
{
    using System;
    partial class Role : SnQTranslator.Contracts.Persistence.Account.IRole
    {
        static Role()
        {
            ClassConstructing();
        ...
        {
            if (obj is not SnQTranslator.Contracts.Persistence.Account.IRole instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(SnQTranslator.Contracts.Persistence.Account.IRole other)
        {
            if (other == null)
            {
                return false;
